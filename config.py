...
POLLING_INTERVALS = {
    ...
    "AVAILABLE": (10, 300),
    "ACTIVE": (10, 300),
    "REFRESHING": (10, 300),  # 🆕 فاصل مراقبة حالة التحديث
    "TRANSFERRING": (10, 300),  # 🆕 فاصل مراقبة حالة النقل
    "CODE SENT": (5, 15),
...
FINAL_STATUSES: Set[str] = {
    "AVAILABLE",
    "ACTIVE",
    "REFRESHING",  # 🆕 حالة تحديث الحساب
    "TRANSFERRING",  # 🆕 حالة نقل اللاعيبة
    "WRONG DETAILS",
    "BACKUP CODE WRONG",
    "CODE SENT",
    "DISABLED",
...
STATUS_DESCRIPTIONS_AR = {
    ...
    "REFRESHING": "جاري التحديث - الحساب بيتحدث دلوقتي",  # 🆕 وصف التحديث
    "TRANSFERRING": "جاري النقل - بيتم نقل اللاعيبة حالياً",  # 🆕 وصف النقل
